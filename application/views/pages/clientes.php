			...
			<div class="container-fluid">
                <div class="page-header">
                    ...
                    <div class="pull-right">
                        <button class="btn-block btn btn-lime btn-large" onClick="location.href='<?php echo base_url(); ?>productor/otros/cliente/crear'"><i class="icon-plus"></i> Crear Nuevo Cliente</button>
                    </div>
                </div>
                        ...
                        <div class="box">  
							...
							?>
								<div class="alert">
									...
									<i class="icon-info-sign"></i> <strong>Algo que deberias saber!</strong> Los clientes son utilizados en las distribuciones. (no podra registrar distribuciones hasta que no tenga algun cliente registrado)
								</div> 
                            <?php
							}
							...
							<?php
								...
								<div class="alert alert-success">
									<button type="button" class="close" data-dismiss="alert">×</button>
									<i class="icon-ok-sign"></i> <strong>Excelente!</strong> se ha editado al cliente con éxito.
								</div>
							<?php
								}
							}
                                ...
                                <div class="box-content nopadding">
                                    <table class="table table-hover table-nomargin dataTable table-bordered" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr  onclick='location.href="<?php echo base_url(); ?>productor/otros/cliente/editar/<?php echo $cliente['id']; ?>"' style="cursor:pointer;" title="Click para ver detalles" >             
                                                <td><?php echo $cliente['tipo_cedula_rif'].'-'.$cliente['cedula_rif']; ?></td>
