...
<body>
	<div id="modal-pro" class="modal hide in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false" >
        ...
        <div class="modal-body" style="min-height:50px;">
            ...
            <form action="<?php echo base_url(); ?>coordinador/productores_zona/<?php echo $productor['id'].'/'.$nombre_url; ?>/produccion/crear" method="POST" class="form-horizontal " name="form_crear_produccion"> 
            	
				<input type="hidden" name="productor" value="<?php echo $productor['id']; ?>">
