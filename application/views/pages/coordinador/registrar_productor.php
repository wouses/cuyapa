                                    ...
                                    <div id="pro-cont"> 
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <input type="text" name="cedula_rif" id="cedula_rif" class="input-medium num_only" style="float:left; margin-left:5px;" maxlength="9" > 
                                            </div><!-- /.controls -->
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <input type="text" pattern="\d*" name="telefono" id="telefono" class="input-medium num_only"  maxlength="7" style="float:left; margin-left:5px;" > 
                                            </div><!-- /.controls -->
                                        </div>
