		...
		<div id="main">
			<div class="container-fluid">
                ...
                <div class="breadcrumbs">
                    <ul>
                        <li>
                            <a href="<?php echo base_url(); ?>index.php/administrador/variedad">Variedades</a>
                    ...
                    <div class="span12">
                        <div class="box">
                        	...
                        	<div class="box-title">
                                ...
                                <a href="<?php echo base_url(); ?>administrador/variedad/eliminar/<?php echo $modalidad['id']; ?>" onClick="return confirm('Deseas eliminar el registro? No podras recuperar la información');" class="btn btn-danger" style="float:right"><i class="icon-trash"></i> Eliminar</a>
							</div>
							<div class="box-content">
								<form action="<?php echo base_url(); ?>administrador/variedad/editar" method="POST" class="form-horizontal" name="form_crear_variedad" >
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="nombre" id="textfield" class="input-xlarge" data-rule-required="true" value="<?php echo $modalidad['nombre']; ?>">
										</div>
									</div>
																	
									<div class="form-actions">
										<button type="button" class="btn btn-primary" onClick="validar18()">Guardar</button>
										<button type="button" class="btn" onClick="location.href='<?php echo base_url(); ?>administrador/modalidad'">Cancelar</button>
									</div>
								</form>
							</div>
                        </div>
