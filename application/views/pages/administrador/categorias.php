			...
			<div class="container-fluid">
                <div class="page-header">
                    ...
                    <div class="pull-right">
                        <button class="btn-block btn btn-lime btn-large" onClick="location.href='<?php echo base_url(); ?>administrador/categoria/crear'"><i class="icon-plus"></i> Crear Nueva Categor&iacute;a</button>
                    </div>
                </div>
                        ...
                        <div class="box">
							...
							if(isset($_REQUEST['alert'])){
								...
								<div class="alert alert-success">
									...
									<i class="icon-ok-sign"></i> <strong>Excelente!</strong> Se ha realizado el registro con exito.
								</div>
							<?php
							...
							<?php
								...
								<div class="alert alert-success">
									<button type="button" class="close" data-dismiss="alert">×</button>
									<i class="icon-ok-sign"></i> <strong>Excelente!</strong> Se ha editado el registro con exito.
								</div>
							<?php
							...
							<?php
								...
								<div class="alert alert-success">
									<button type="button" class="close" data-dismiss="alert">×</button>
									<i class="icon-ok-sign"></i> <strong>Excelente!</strong> Se ha eliminado el registro con exito.
								</div>
							<?php
								}
							...
							<div class="box-content nopadding">
								<table class="table table-hover table-nomargin dataTable table-bordered">
									...
									<tbody>
										...
										<tr onClick="location.href='<?php echo base_url(); ?>administrador/categoria/editar/<?php echo $categoria['id']; ?>'" style="cursor:pointer;">
