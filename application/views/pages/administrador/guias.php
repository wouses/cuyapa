			...
			<div class="container-fluid">
                <div class="page-header">
                    ...
                    <div class="pull-right">
                        <button class="btn-block btn btn-lime btn-large" onClick="location.href='<?php echo base_url(); ?>administrador/guia/crear'"><i class="icon-plus"></i> Crear Nueva Gu&iacute;a</button>
                    </div>
                </div>
                        ...
                        <div class="box">
							...
							<?php
								...
								<div class="alert alert-error">
									<button type="button" class="close" data-dismiss="alert">×</button>
									<strong>Error!</strong> se ha realizado el registro, pero no se pudo guardar el archivo.
								</div>
							<?php
							...
							<?php
								...
								<div class="alert alert-error">
									<button type="button" class="close" data-dismiss="alert">×</button>
									<strong>Error!</strong> se ha editado el registro, pero no se pudo modificar el archivo.
								</div>
							<?php
							...
							<div class="box-content nopadding">
								<table class="table table-hover table-nomargin dataTable table-bordered">
									...
									<tbody>
										...
										<tr onClick="location.href='<?php echo base_url(); ?>administrador/guia/editar/<?php echo $guia['id']; ?>'" style="cursor:pointer;">
											<td><?php echo $guia['nombre']; ?></td>
                                            <td><?php echo $guia['id_producto']; ?></td>
