		...
		<div id="main">
			<div class="container-fluid">
                ...
                <div class="breadcrumbs">
                    <ul>
                        <li>
                            <a href="<?php echo base_url(); ?>index.php/administrador/usos">Usos</a>
                    ...
                    <div class="span12">
                        <div class="box">
                        	...
                        	<div class="box-title">
                                ...
                                <a href="<?php echo base_url(); ?>administrador/uso/eliminar/<?php echo $uso['id']; ?>" onClick="return confirm('Deseas eliminar el registro? No podras recuperar la información');" class="btn btn-danger" style="float:right"><i class="icon-trash"></i> Eliminar</a>
							</div>
							<div class="box-content">
								<form action="<?php echo base_url(); ?>administrador/uso/editar" method="POST" class="form-horizontal" name="form_crear_uso">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="nombre" id="textfield" class="input-xlarge"  value="<?php echo $uso['nombre']; ?>">
										</div>
									</div>
																	
									<div class="form-actions">
										<button type="button" class="btn btn-primary" onClick="validar19()">Guardar</button>
										<button type="button" class="btn" onClick="location.href='<?php echo base_url(); ?>administrador/usos'">Cancelar</button>
									</div>
								</form>
							</div>
                        </div>
