		...
		<div id="main">
			<div class="container-fluid">
                <div class="page-header">
                    <div class="pull-left">
                        <h1>Editar Probabilidad de Éxito</h1>
                    </div>
                </div>
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                        	...
                        	<div class="alert alert-error">
                                <button type="button" class="close" data-dismiss="alert">×</button>
                                <strong>Error!</strong> La fecha de inicio no puede ser mayor o igual a la fecha final.
                            </div>
                            <?php
								}else if($error==3){
							?>
                        	...
                        	<div class="box-title">
                                ...
                                <a href="<?php echo base_url(); ?>administrador/probabilidad_exito/eliminar/<?php echo $probabilidad['idprobabilidad']?>" onClick="return confirm('Deseas eliminar el registro? No podras recuperar la información');" class="btn btn-danger" style="float:right"><i class="icon-trash"></i> Eliminar</a>
							</div>
							<div class="box-content">
								<form action="<?php echo base_url(); ?>administrador/probabilidad_exito/editar" method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="enviar" value="1">
                                <input type="hidden" name="idprobabilidad" value="<?php echo $probabilidad['idprobabilidad']?>" >
