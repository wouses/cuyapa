			...
			<div class="container-fluid">
                <div class="page-header">
                    ...
                    <div class="pull-right">
                        <button class="btn-block btn btn-lime btn-large" onClick="location.href='<?php echo base_url(); ?>administrador/variedad/crear'"><i class="icon-plus"></i> Crear Nueva Variedad</button>
                    </div>
                </div>
							...
							<div class="box-content nopadding">
								<table class="table table-hover table-nomargin dataTable table-bordered">
									...
									<tbody>
										...
										<tr onClick="location.href='<?php echo base_url(); ?>administrador/variedad/editar/<?php echo $modalidad['id']; ?>'" style="cursor:pointer;">
