		...
		<div id="main">
			<div class="container-fluid">
                ...
                <div class="breadcrumbs">
                    <ul>
                        <li>
                            <a href="<?php echo base_url(); ?>administrador/comentario">Comentarios</a>
                       		<i class="icon-angle-right"></i>
                        </li>
                        <li>
                            <a href="#">Detalle Comentario</a>
                        </li>
                    </ul>
                </div>
                <div class="row-fluid">
                        ...
                        <div class="box"> 
                            <div class="span12" >
                                <div class="box-content ">
                                    <h1><?php echo $comentario['correo']; ?></h1>
                                    <p><strong>Ubicacion:</strong> <?php echo $comentario['ubicacion']; ?></p>
                                    <p><strong>Fecha:</strong> <?php echo $comentario['fecha']; ?></p>
                                    <br>

                                    <p><strong>Sentimiento:</strong> <?php echo $comentario['sentimiento']; ?></p>
                                    <p><strong>Asunto:</strong> <?php echo $comentario['asunto']; ?></p> 
									<pre><?php echo $comentario['opinion']; ?></pre>
                                    <a href="<?php echo base_url(); ?>administrador/comentario" class="btn btn-primary" style="float:right"> Regresar</a>
                                    <a href="<?php echo base_url(); ?>administrador/eliminar_comentario/<?php echo $comentario['id']; ?>" onClick="return confirm('Deseas eliminar el registro? No podras recuperar la información');" class="btn btn-danger" style="float:right; margin-right:5px;"><i class="icon-trash"></i> Eliminar</a> 
