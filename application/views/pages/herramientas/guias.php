                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                        	...
                        	<div class="box-title">
								<h3><i class="icon-file-alt"></i>Selecciona la guia que deseas consultar.</h3>
							</div>
                            <br/>
                            <div class="span11">
                                <div class="box-content nopadding">
                                    <table class="table table-hover table-nomargin dataTable table-bordered" id="tabla_guia">
                                        ...
                                        <tbody>
                                            ...
                                            <tr onClick="window.open('<?php echo base_url(); ?><?php echo $guia['ruta'];?>','_blank');" style="cursor:pointer;" title='Click para abrir'>
                                                <td><?php echo $guia['nombre']; ?></td>
                                                <td><?php echo $guia['categoria']; ?></td>
                                                <td><?php echo $guia['subcategoria']; ?></td>
                                            </tr>
                                            <?php
