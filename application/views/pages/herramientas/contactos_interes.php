		...
		<div id="main">
			<div class="container-fluid">
                <div class="page-header">
                    <div class="pull-left">
                        <h1>Contactos de Inter&eacute;s</h1>
                    </div>
                ...
                <div class="breadcrumbs">
                    <ul>
                        <li>
                            <a href="#">Contactos de Inter&eacute;s</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                        	...
                        	<div class="box-title">
								<h3><i class="icon-phone-sign"></i>Busca entre los servicios y productos que tenemos para ayudarte.</h3>
							</div>
							<br/>
                            <div class="span11">
                                <div class="box-content nopadding">
                                    <table class="table table-hover table-nomargin dataTable table-bordered" id="tabla_guia">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr style="cursor:pointer;" title='Click para abrir' onClick="location.href='<?php echo base_url(); ?>productor/herramientas/contactos/<?php echo $contacto['id']; ?>/<?php echo $contacto['titulo']; ?>'">
