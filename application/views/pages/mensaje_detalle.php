		...
		<div id="main">
			<div class="container-fluid">
                ...
                <div class="breadcrumbs">
                    <ul>
                        <li>
                            <a href="<?php echo base_url(); ?>productor/mensaje">Centro de Mensajes</a>
                       		<i class="icon-angle-right"></i>
                        </li>
                        <li>
                            <a href="#">Detalle Mensaje</a>
                        </li>
                    </ul>
                </div>
                <div class="row-fluid">
                        ...
                        <div class="box"> 
                            <div class="span12" >
                                <div class="box-content ">
                                    <h1><?php echo $mensaje['nombre']; ?></h1>
                                    <p><strong>Teléfono:</strong> <?php echo $mensaje['telefono']; ?></p>
                                    <p><strong>Correo:</strong> <?php echo $mensaje['correo']; ?></p>
                                    <p><?php echo $mensaje['fecha']; ?></p> 
									<pre><?php echo $mensaje['mensaje']; ?></pre>
                                    <a href="<?php echo base_url(); ?>productor/mensaje" class="btn btn-primary" style="float:right"> Regresar</a>
                                    <a href="<?php echo base_url(); ?>productor/eliminar_mensaje/<?php echo $mensaje['id']; ?>" onClick="return confirm('Deseas eliminar el registro? No podras recuperar la información');" class="btn btn-danger" style="float:right; margin-right:5px;"><i class="icon-trash"></i> Eliminar</a> 
