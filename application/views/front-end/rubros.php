...
<div class="container">
    ...
    <div id="main">
        <div class="row">
            <div class="span9">
                <h1 class="page-header">Rubros de <?php echo ucfirst($categoria['nombre']); ?></h1>
                ...
                <div class="properties-rows">
                    <div class="row">
						...
						?>
                        <div class="property span9" style="cursor:pointer" onClick="location.href='<?php echo base_url(); ?>productores/<?php echo $categoria['nombre']; ?>/<?php echo $rubro['rubro']; ?>'" >
                            <div class="row"> 
                                <div class="body span9">
                                    <div class="title-price row">
                                        <div class="title span6">
                                            <h1 style="padding-left:15px;"><a style="text-decoration:none;"><?php echo $rubro['rubro']; ?></a></h1>
                                        </div><!-- /.title -->
                                        <div class="span3" align="right">
                                        	<h3 style="padding-right:15px;"><?php if($rubro['contador']==1){ echo $rubro['contador'].' Productor'; }else{ echo $rubro['contador'].' Productores'; } ?></h3>
                                        </div>
                                    </div><!-- /.title -->
                                    <p> </p>
                                </div><!-- /.body -->
