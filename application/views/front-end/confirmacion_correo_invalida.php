...
<div id="wrapper-outer" >
    ...
    <div id="main">
        <div class="mail-send">
            ...
            <hr>
            <p>
                Al parecer quieres activar una cuenta de cuyapa con información incorrecta, <br>por favor accede a esta página a través de un enlace valido.
				<br><br>
                <b>Una pista:</b> hemos enviado uno a tu correo.
                <br><br> 
            </p>
        </div>
    </div>
