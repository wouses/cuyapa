                ...
                <div class="properties-rows">
                    <div class="row">
						...
						if($categorias){
							...
							?>
							<div class="property span9" style="cursor:pointer" onClick="location.href='<?php echo base_url(); ?>rubros/<?php echo $categoria['nombre']; ?>'">
								<div class="row"> 
									<div class="body span9">
										<div class="title-price row">
											<div class="title span6">
												<h1 style="padding-left:15px;"><a style="text-decoration:none;"><?php echo $categoria['nombre']; ?></a></h1>
											</div><!-- /.title -->
											<div class="span3" align="right">
												<h3 style="padding-right:15px;"><?php if($categoria['contador']==1){ echo $categoria['contador'].' Rubro'; }else{ echo $categoria['contador'].' Rubros'; } ?></h3>
											</div>
										</div><!-- /.title -->
										<p> </p>
									</div><!-- /.body -->
                            ...
                            <div class="span9" align="center">
                                <img src="<?php echo base_url(); ?>img/baby_plant.png">
                                <h1>No hay Categor&iacute;as</h1>
                                <hr style="widht:700px;" align="center">
                                <p>Al parecer no hay productores ofreciendo ningún rubro, prueba más tarde</p>
                            </div>
                            <?php
						}
						?>
