...
<div id="wrapper-outer" >
                            ...
                            <div class="navbar">
                                <div class="navbar-inner">
                                    <div class="row">
                                       ...
                                       <a class="btn btn-primary btn-large list-your-property  arrow-right" href="<?php echo base_url(); ?>productor">Ingresar</a> <a class="btn btn-primary btn-large list-your-property" href="<?php echo base_url(); ?>registro">Registrate</a>
                                    </div><!-- /.row -->
                                </div><!-- /.navbar-inner -->
                            </div><!-- /.navbar -->
                        </div><!-- /.container -->
    ...
    <div id="main">
        <div class="mail-send">
			<div align="center"><img src="<?php echo base_url(); ?>img/icons/mail-check.png" width="250" ></div>
			<br>
            <h1>Cuenta activada con éxito!</h1>
            <hr>
            <p>
                Tu correo ha sido confimado exitosamente, ahora podras acceder y disfrutar de todos los beneficios que te ofrecemos.
				<br><br>
				<a class="btn btn-primary btn-large list-your-property arrow-right" href="<?php echo base_url(); ?>productor" style="text-decoration:none;">Ingresar</a> 
            </p>
        </div>
    </div>
</div>
