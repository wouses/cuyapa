...
<div id="wrapper-outer" >
    ...
    <div id="main">
        <div class="mail-send">
			<div align="center"><img src="<?php echo base_url(); ?>img/teamt.png" width="200" ></div>
			<br>
            <h1>Registro culminado con éxito!</h1>
            <hr>
            <p>
                Un coordinador de tu municipio verificara la información que has brindado para posteriormente activar tu cuenta en Cuyapa, Este proceso puede tomar unas <b>48 horas</b> hábiles.
				<br><br>
				Se te enviara una notificación a tu correo (<b><?php echo $correo; ?></b>) cuando tu cuenta sea activada, si es necesario el coordinador te contactara via telefónica. 
            </p>
        </div>
    </div>
</div>
