...
function LoadMapProperty() {
    ...
    var mapOptions = {
        center: new google.maps.LatLng(10.230127, -67.328022),
        zoom: 16,
...
function LoadMap() {
	...
	var locations = new Array(
        [10.230127, -67.328022], [34.006673,-118.486562], [34.009714,-118.480296], [34.010408,-118.473215], [34.01521,-118.474889], [34.022502,-118.480124],
    ...
    $.each(locations, function(index, location) {
	    ...
	    var myOptions = {
	        content: '<div class="infobox"><div class="image"></div><div class="title"><a href="#">Fresa la coloniera</a></div><div class="price">12,45 Bs/Kg</div><div class="link"><a href="#l">Ver mas</a></div></div>',
	        disableAutoPan: false,
	        maxWidth: 0,
	        pixelOffset: new google.maps.Size(-146, -190),
	        zIndex: null,
